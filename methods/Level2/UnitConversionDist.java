...
public class UnitConversionDist {
	...
	public static void main(String[] args){
		...
		double yards2feet= UnitConversionDist.convertyardstofeet(yards);
		System.out.println("yards to feet is "+yards2feet);
		
		System.out.println("Enter the Distance in feet :");
		double feet=input.nextDouble();
		double feet2yards= UnitConversionDist.convertfeettoyards(feet);
		System.out.println("feet to yards is "+feet2yards);
		
		System.out.println("Enter the Distance in meters :");
		double meters=input.nextDouble();
		double meters2inches= UnitConversionDist.convertmeterstoinches(meters);
		System.out.println("meters to inches is "+meters2inches);
		
		
		System.out.println("Enter the Distance in inches :");
		double inches=input.nextDouble();
		double inches2meters= UnitConversionDist.convertinchestometers(inches);
		System.out.println("inches to meters is "+inches2meters);
		
		System.out.println("Enter the Distance in inches :");
		double inches1=input.nextDouble();
		double inches2cm= UnitConversionDist.convertinchestocm(inches1);
