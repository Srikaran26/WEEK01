...
public class Level2q8{
	public static void main(String[] args){
		...
		for (int i=0;i<count;i++){
			physics=validchecker(input,"Physics",i);
			chemistry=validchecker(input,"Chemistry",i);
			maths=validchecker(input,"Maths",i);
			...
			System.out.println("Student "+(i+1)+" scored total marks: "+marks[i]+" out of 300 and holds a percentage value of "+percentage[i]+" and secured Grade "+(Grade[i]));
		}
	}
